      ...
      *              - STORED IN XPEDITER/TSO SAMPLIB (XEXTDATA)       *
      *  OUTPUT FILE - EMPLOYEE COMPENSATION REPORT                    *
      *              - REGIONAL SALES REPORT                           *
      *                                                                *
      *  RUN JCL     - STORED IN XPEDITER/TSO SAMPLIB (XEXTJCLC)       *
      *  test                                                          *
      ******************************************************************
...
********
********  FIELDS USED BY CALLED PROGRAM XEXTSUBC TO CALCULATE
...
*********
       2000-PROCESS-HOURLY.
           ...
           IF WA-EMP-HOURS GREATER THAN 40
               ...
               COMPUTE OT-AMOUNT = OT-HOURS * (WA-EMP-RATE * 3.0)
           ELSE
           ...
           CALL 'XEXTDATE' USING END-OF-MONTH-SW
                                 YRS-OF-SERVICE
                                 TODAYS-DATE
                                 WA-EMP-HIRE-DATE.
...
*********  RETURNED FROM XEXTSUBC, IT IS STORED IN A HOLD-TABLE.  THE
